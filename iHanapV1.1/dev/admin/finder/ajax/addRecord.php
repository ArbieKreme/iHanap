<?php
    if(isset($_POST['mp_firstname']) && isset($_POST['mp_lastname']) && isset($_POST['mp_email']))
    {
        ...
        $query = "INSERT INTO missingpersons(mp_firstname, mp_middlename, mp_lastname, mp_relative, mp_email, mp_house_number,
          mp_street, mp_city, mp_nativity, mp_age, mp_last_seen, mp_status, mp_gender, mp_height, mp_weight)
        VALUES('$mp_firstname', '$mp_middlename', '$mp_lastname', '$mp_relative', '$mp_email', '$mp_house_number',
