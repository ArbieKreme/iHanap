...
<!-- First Grid -->
<div class="w3-row-padding w3-padding-64 w3-container" style="padding:200px 20px" id="aboutfinder">
  <?php
...
<!-- Second Grid -->
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container" style="padding:200px 20px" id="aboutus">
  <?php
  include 'aboutus.php';
  ?>
</div>
